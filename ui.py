...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.right_btn = Button(image=right_img, highlightthickness=0, command=lambda:self.check_answer("True"))
        self.right_btn.grid(row=2, column=0)

        wrong_img = PhotoImage(file="images/false.png")
        self.wrong_btn = Button(image=wrong_img, highlightthickness=0, command=lambda:self.check_answer("False"))
